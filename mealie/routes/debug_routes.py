...
from cena.core.config import APP_VERSION, app_dirs, settings
...
from cena.schema.about import AppInfo, AppStatistics, DebugInfo
...
async def get_cena_version():
    """ Returns the current version of cena"""
    return AppInfo(
        version=APP_VERSION,
        demo_status=settings.IS_DEMO,
        production=settings.PRODUCTION,
