...
from cena.schema.migration import MigrationImport
from cena.services.migrations import chowdown, nextcloud
...
class Migration(str, Enum):
    """The class defining the supported types of migrations for Cena. Pass the
