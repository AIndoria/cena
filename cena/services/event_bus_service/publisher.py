...
from cena.services.event_bus_service.event_bus_service import EventBusMessage
...
class ApprisePublisher:
    def __init__(self, hard_fail=False) -> None:
        asset = apprise.AppriseAsset(
            async_mode=True,
            image_url_mask="https://raw.githubusercontent.com/aindoria/cena/dev/frontend/public/img/icons/android-chrome-maskable-512x512.png",
        )
