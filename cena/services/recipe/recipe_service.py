...
from cena.schema.recipe.recipe import CreateRecipe, Recipe
from cena.schema.recipe.recipe_ingredient import RecipeIngredient
from cena.schema.recipe.recipe_settings import RecipeSettings
from cena.schema.recipe.recipe_step import RecipeStep
from cena.schema.user.user import GroupInDB, PrivateUser
...
class RecipeService(BaseService):
    ...
    def create_from_zip(self, archive: UploadFile, temp_path: Path) -> Recipe:
        """
        `create_from_zip` creates a recipe in the database from a zip file exported from Cena. This is NOT
