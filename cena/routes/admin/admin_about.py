...
from cena.core.release_checker import get_latest_version
from cena.core.settings.static import APP_VERSION
from cena.routes._base import BaseAdminController, controller
from cena.schema.admin.about import AdminAboutInfo, AppStatistics, CheckAppConfig, DockerVolumeText
...
class AdminAboutController(BaseAdminController):
    ...
    def check_app_config(self):
        ...
        return CheckAppConfig(
            ...
            base_url_set=settings.BASE_URL != "http://localhost:24678",
