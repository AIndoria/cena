...
from cena.schema.group.group_migration import SupportedMigrations
from cena.schema.reports.reports import ReportSummary
from cena.services.migrations import (
    BaseMigrator,
    ChowdownMigrator,
    CenaAlphaMigrator,
    NextcloudMigrator,
...
class GroupMigrationController(BaseUserController):
    ...
    def start_data_migration(
        ...
        match migration_type:
            ...
            case SupportedMigrations.cena_alpha:
                migrator = CenaAlphaMigrator(**args)
