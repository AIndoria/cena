...
from cena.core.exceptions import cena_registered_exceptions
from cena.repos.repository_meals import RepositoryMeals
...
from cena.schema.meal_plan import CreatePlanEntry, ReadPlanEntry, SavePlanEntry, UpdatePlanEntry
from cena.schema.meal_plan.new_meal import CreatRandomEntry
from cena.schema.meal_plan.plan_rules import PlanRulesDay
from cena.schema.recipe.recipe import Recipe
...
class GroupMealplanController(BaseUserController):
    ...
    def registered_exceptions(self, ex: type[Exception]) -> str:
        registered = {
            **cena_registered_exceptions(self.deps.t),
        }
