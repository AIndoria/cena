...
from cena.core.dependencies.dependencies import temporary_zip_path
...
from cena.schema.recipe.recipe_bulk_actions import (
    AssignCategories,
    AssignTags,
    BulkActionsResponse,
    DeleteRecipes,
...
from cena.services.recipe.recipe_bulk_service import RecipeBulkActionsService
