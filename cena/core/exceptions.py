...
from cena.lang.providers import Translator
...
def cena_registered_exceptions(t: Translator) -> dict:
    """
    This function returns a dictionary of all the globally registered exceptions in the Cena application.
    """
