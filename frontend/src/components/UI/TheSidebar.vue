  ...
  <div class="d-print-none no-print">
    <v-navigation-drawer v-model="showSidebar" width="180px" clipped app>
      ...
      <v-list nav dense class="fixedBottom" v-if="!isMain">
        <!-- <v-list-item href="https://github.com/sponsors/aindoria" target="_target">
          <v-list-item-icon>
        ...
        <v-list-item to="/admin/about">
          ...
          <v-list-item-content>
            ...
            <v-list-item-subtitle>
              <a
                @click.prevent
                href="https://github.com/hay-kot/cena/releases/latest"
                target="_blank"
...
export default {
  ...
  methods: {
    ...
    async getVersion() {
      let response = await axios.get("https://api.github.com/repos/hay-kot/cena/releases/latest", {
        headers: {
