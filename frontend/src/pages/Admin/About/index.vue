<template>
  <div>
    <v-app-bar color="primary">
      <v-spacer></v-spacer>
      <v-btn href="https://github.com/sponsors/aindoria" target="_blank" class="mx-1" color="secondary">
        <v-icon left>
          {{ $globals.icons.heart }}
        </v-icon>
        {{ $t("about.support") }}
      </v-btn>
      <v-btn href="https://github.com/aindoria" target="_blank" class="mx-1" color="secondary">
        <v-icon left>
          {{ $globals.icons.github }}
        </v-icon>
        {{ $t("about.github") }}
      </v-btn>
      <v-btn href="https://aindoria.com" target="_blank" class="mx-1" color="secondary">
        <v-icon left>
