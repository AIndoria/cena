<template>
  <v-container fluid>
    <BannerExperimental issue="https://github.com/aindoria/cena/issues/871"></BannerExperimental>
    <section>
      <!-- Delete Dialog -->
      <BaseDialog
      ...
      <section>
        <BaseCardSectionTitle title="Backups">
          <v-card-text class="py-0 px-1">
            ...
            be set to exclude subsets of data. You can think off this as a snapshot of Cena at a specific time.
