<template>
  <v-container fluid class="md-container">
    ...
    <BaseCardSectionTitle title="Site Analytics">
      Your instance of Cena can send anonymous usage statistics to the Cena project team. This is done to help us
      gauge the usage of cena, provide public statistics and to help us improve the user experience.
    ...
    <section class="my-8">
      <BaseCardSectionTitle class="pb-0" :icon="$globals.icons.chart" title="Analytics Data">
        This is a list of all the data that is sent to the Cena project team.
      </BaseCardSectionTitle>
      <v-card class="ma-2">
...
export default defineComponent({
  ...
  setup() {
    ...
    function getValue(key: keyof CenaAnalytics) {
