  ...
  >
    <v-card tag="section" class="d-flex flex-column align-center" width="600px">
      <v-toolbar width="100%" color="primary" class="d-flex justify-center mb-4" dark>
        <v-toolbar-title class="headline text-h4"> Cena </v-toolbar-title>
      </v-toolbar>

      <div class="icon-container">
        <!-- <v-divider class="icon-divider"></v-divider> -->
        <img
          src="../components/Layout/cena_new_full_transparent.png"
          style="height: 175px"
          v-if="!$vuetify.theme.dark"
        />
        <img src="../components/Layout/cena_new_transparent.png" style="height: 175px" v-if="$vuetify.theme.dark" />
          ...
          v-for="link in [
            {
              ...
              href: 'https://github.com/sponsors/aindoria',
            },
            {
              text: 'GitHub',
              icon: $globals.icons.github,
              href: 'https://github.com/aindoria/cena',
            },
          ]"
          :key="link.text"
        >
