          ...
          <v-tab-item value="url" eager>
            <v-form ref="domUrlForm" @submit.prevent="createByUrl(recipeUrl)">
              <v-card flat>
                ...
                <v-card-text>
                  Scrape a recipe by url. Provide the url for the site you want to scrape, and Cena will attempt to
            ...
            <v-expand-transition>
              <v-alert v-show="error" color="error" class="mt-6 white--text">
                ...
                <div class="d-flex row justify-space-around my-3 force-white">
                  ...
                  <a href="https://github.com/aindoria/cena/issues" target="_blank" rel="noreferrer nofollow">
          ...
          <v-tab-item value="zip" eager>
            <v-form>
              <v-card>
                ...
                <v-card-text>
                  Import a single recipe that was exported from another Cena instance.
                  <v-file-input
                    ...
                    rounded
                    truncate-length="100"
                    hint=".zip files must have been exported from Cena"
                    persistent-hint
                    prepend-icon=""
            ...
            <v-form ref="domUrlForm" @submit.prevent="debugUrl(recipeUrl)">
              <v-card flat>
                ...
                <v-card-text>
                  ...
                  to scrape is not supported by Cena or it's scraper library.
                  <v-text-field
                    v-model="recipeUrl"
                    :label="$t('new-recipe.recipe-url')"
                    validate-on-blur
          ...
          <v-tab-item value="bulk" eager>
            <v-card flat>
              ...
              <v-card-text>
                ...
                backend and running the task in the background. This can be useful when initially migrating to Cena,
