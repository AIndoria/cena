<template>
  <v-container>
    <BasePageTitle divider>
      ...
      Recipes can be migrated from another supported application to Cena. This is a great way to get started with
      Cena.
    </BasePageTitle>
    <v-container>
...
export default defineComponent({
  setup() {
    ...
    const _content = {
      ...
      [MIGRATIONS.chowdown]: {
        text: "Cena natively supports the chowdown repository format. Download the code repository as a .zip file and upload it below",
        tree: [
          {
            id: 1,
            icon: $globals.icons.zip,
      ...
      [MIGRATIONS.paprika]: {
        text: "Cena can import recipes from the Paprika application. Export your recipes from paprika, rename the export extension to .zip and upload it below.",
        tree: false,
      },
      [MIGRATIONS.cena]: {
        text: "Cena can import recipes from the Cena application from a pre v1.0 release. Export your recipes from your old instance, and upload the zip file below. Note that only recipes can be imported from the export.",
        tree: [
          {
            id: 1,
            icon: $globals.icons.zip,
