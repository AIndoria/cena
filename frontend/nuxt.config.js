export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: "og:title", property: "og:title", content: "Cena" },
      { hid: "og:site_name", property: "og:site_name", content: "Cena" },
      { hid: "og:desc", property: "og:description", content: "Cena is a recipe management app for your kitchen." },
      {
        hid: "og-image",
        property: "og:image",
        content:
          "https://raw.githubusercontent.com/aindoria/cena/dev/frontend/public/img/icons/android-chrome-512x512.png",
      },
      { charset: "utf-8" },
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        hid: "description",
        name: "description",
        content: "Cena is a recipe management app for your kitchen.",
      },
    ],
  ...
  pwa: {
    ...
    meta: {
      /* meta options */
      name: "Cena",
      description: "Cena is a recipe management and meal planning app",
      theme_color: "#E58325",
      ogSiteName: "Cena",
    },
    manifest: {
