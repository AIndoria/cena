<template>
  <v-app-bar clipped-left dense app color="primary" dark class="d-print-none">
    ...
    <div style="display:flex; justify-content:center;"><router-link to="/">
      <!-- <v-btn icon> -->
        <v-toolbar-title style="cursor: pointer" @click="$router.push('/')"> <img src="./cena_new_transparent.png" style="height:3rem; margin-top:10px"></v-toolbar-title>
      <!-- </v-btn> -->
    </router-link></div>
