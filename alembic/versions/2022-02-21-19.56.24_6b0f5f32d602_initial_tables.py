...
import cena.db.migration_types
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("group_id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("name", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("group_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("group_id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("user_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("name", sa.String(), nullable=False),
        sa.Column("description", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("recipee_id", cena.db.migration_types.GUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("cookbook_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("category_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("event_notifier_id", cena.db.migration_types.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("group_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("recipe_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("description", sa.String(), nullable=True),
        sa.Column("label_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("group_plan_rule_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("category_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
    ...
    op.create_table(
        "plan_rules_to_tags",
        sa.Column("plan_rule_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("tag_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["plan_rule_id"],
            ["group_meal_plan_rules.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("group_id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("recipe_id", cena.db.migration_types.GUID(), nullable=False),
    ...
    op.create_table(
        "recipes_to_tools",
        sa.Column("recipe_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("tool_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["recipe_id"],
            ["recipes.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("timestamp", sa.DateTime(), nullable=False),
        sa.Column("report_id", cena.db.migration_types.GUID(), nullable=False),
        sa.ForeignKeyConstraint(
            ["report_id"],
            ["group_reports.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("shopping_list_id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("recipe_id", cena.db.migration_types.GUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("owned_recipes_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("user_id", cena.db.migration_types.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("instruction_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("reference_id", cena.db.migration_types.GUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["instruction_id"],
    ...
    op.create_table(
        ...
        sa.Column("unit_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("food_id", cena.db.migration_types.GUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("shopping_list_id", cena.db.migration_types.GUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("update_at", sa.DateTime(), nullable=True),
        sa.Column("id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("shopping_list_item_id", cena.db.migration_types.GUID(), nullable=False),
        sa.Column("recipe_id", cena.db.migration_types.GUID(), nullable=True),
        sa.Column("recipe_quantity", sa.Float(), nullable=False),
        sa.ForeignKeyConstraint(
            ["recipe_id"],
