...
## Report bugs using Github's [issues](https://github.com/aindoria/cena/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/aindoria/cena/issues/new); it's that easy!
