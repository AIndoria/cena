...
## Report bugs using Github's [issues](https://github.com/hay-kot/cena/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/hay-kot/cena/issues/new); it's that easy!
