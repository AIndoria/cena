...
!!! tip "Cena data that is saved on backups" - [x] Recipe Data - [ ] Meal Plan - [x] Site Settings - [x] Custom Pages - [x] User Data - [x] Group Data
...
You can use the API to create and retrieve backups remotely from any server that can access the Cena instance. This is useful for easily managing off-site backups via cron-job or other scheduled tasks. You can find interactive documentation for your API at https://your-cena-instance.com/docs
...
If you decide you don't like cena: This is a good way to export into a format that can be imported into another.
